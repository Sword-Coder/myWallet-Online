// CORRECTED onMounted section for BudgetsPage.vue
// REPLACE the existing onMounted function (around line 572) with this:
...
onMounted(async () => {
  ...
  // NEW FIX: Force UI refresh after budgets are loaded
  setTimeout(() => {
