  ...
  try {
    if (editingWallet.value) {
      ...
      const walletData = {
        ...
        // Balance will be recalculated from transactions to include both initialBalance AND transaction net
        // We need to calculate the full balance to preserve the transaction history
        balance: financesStore.calculateWalletBalance(editingWallet.value._id),
