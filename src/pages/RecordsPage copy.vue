...
async function finishTransaction() {
  ...
  try {
    ...
    // 🔧 FIX: Refresh all related data after ANY transaction (not just transfers)
    // This ensures the balance is recalculated with the new transaction
    console.log('🔄 Refreshing all data after transaction...')
    await financesStore.loadAll()
    console.log('✅ Data refreshed successfully')

    // 🔧 ENHANCED: Additional refresh for transfer-specific operations
